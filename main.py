...
# ════════════════════════════════════════════════════════════════
BATA_LOGO_PNG_B64 = (
    "iVBORw0KGgoAAAANSUhEUgAAAPAAAADwCAYAAAA+VemSAAAK6klEQVR42u3df2zU9R3H8df3e9deS6/ttRQpVOqPahQGFbURCDg1ModBFiXZxDldNjbZ5o"
    "8pKskWpptT5txgkZgJittMzMTJgI3AOhQ3RX4O+SHyo1QQQSgtPXr9de393h/sR5ZsU9vv99v7XJ+PhP9Ivsf77sn7c9e7qyUDbQ3VZgQ4bGLkXcu022wR"
    "K2Bu1BbRAubGbBEtYG7MFtEC5sZsES5gbsgW4QLmhmwTL2DuY90iXMDcbWwTL2BuAxbhAuZuY5t4AXO3sU28gLkR28QLmBuxRbiAuc+LbeIFzN3GNvEC5k"
    "ZsMz7AXH0KmO0LZMcWtokXMDdim3gBcyO2iRcwN2JexAIM9okCZvsC2bmFbeIFzI2YIzSQq0doti+Q3VvYJl7A3Ig5QgO5doRm+wJmbGE2MJBLG5jtC5iz"
    "hdnAQK49BwZgYMAcnwGzjtFsYIAjNIABDZjjM2DeMZoNDHCEBjBgAXN8Bsw8RrOBAY7QAAgYAAEDg4XFC1gAGxgAAQMgYICAARAwAAIGQMAAAQMgYAAEDB"
    "AwAAIGQMAACBggYAAEDICAARAwQMAACBgAAQMEDMAkfkbQPxPa9hh72zPJlNKxmDK9caVjMSXPRJRoDivR0qp4U4t6Go7860+6N8adTcDIJpbfJ59/iFQ0"
    "RJKUP3K4NPa//MV0WtF9jerYtOPsn7e2K9XRxQCz4T7ki90H7wbuq3QsrvYNmxT+fb3a1v2F7UzABGyqZDii5hdeUfOy5UqcPsMDwmO8iIX+PQcbGlLVvD"
    "kav7deox65T75/HMdBwDDpgRQIaOQDs3XZO2s0dOY0BkLAMFHe8Apd9MJPVbPkCbYxAcNUFbfepLFvvqKCC6sZBgHDRAU11RpT/6KKxo9hGAQMI4/Uw8o1"
    "es0yFV02mmEQMEzkCxbpkt89o0D1SIZBwDByE59ToUteeUZ2IMAwCBgmKry0RqMevY9BEDBMVfmt21U88XIGQcAwkmWp+sdzmQMBw1TBulqV3XgtgyBgGH"
    "uU/s4dDIGAYaqSyVcqcP65DIKAYepz4YovTWcOBAxTlV43iSH0E1+pY4COTTt04KbZ/Vt4eX75S4vlKy1WflWlgleMVbBunEqnTpEdyB+Qf1fwynGyhxQq"
    "He3hTiZg/D+ZRFKJ1jYlWtvUe/iYOt7afvYBMDSkYbffrJEPzJY/VOLtKTrPr6LLRqtzy07uII7Q6ItkOKKmxb/R3kkz1b5hs+fXL7joPO4EAkZ/xU+dVs"
    "Ose9RW/6a3AfN5YQKGQ8fsZErvf+1hRfc3enbN/MphDJ6A4ZR0b0zHHlnk3QOQr90hYDirfcNmde/a58m1+N4sAoYLIus3evQItBg2AcPxLfzmNs+O7CBg"
    "UPCKsQrWjVPp9ZNlB/IH5DZlkil+STgB566SyXU5/XuIu3fv8+QTT7mIF7Ew4MKr1jMEAoaJMsmUwq+uZRAEDBO1rX3Dk88bEzDg+PrN6MRTS5kDAcPI57"
    "4r6z351ksCBhyWau/UsR8sYhAEDBMd/d5Tijfx/mcChnFaX13ryfdNEzDgsM6tu/TBvT9kEAQM00T3HdKh2+9XOhZnGAQMozbvtt3aP/3rnvzGQwIGHHTm"
    "D6/p4C1zlGrvZBgO48MMcE06Ftex+QvVvGw5wyBgGHVk3vyOPnhogXoOvM8wCBimiB1v0vHHFiu8Yh3DIGCYIvpeg5oWv6jwqnplkikGQsDIdomWVoVXrV"
    "d4xTp17djLQAgY2SzVHVXX9j3q2Pg3dWzcrq6d+6R0msEQMAZMJqN0PKFMPKF0b0zpnl4lWsJKtLQq0RxW7NgJ9Rw8rOjBw4p9eELKZJhZFrG2hmq5RwBD"
    "8UYOgIABEDAAAgYIGAABAyBgAAQMEDAAAgZAwAABAyBgAAQMgIABAgZAwAAIGAABAwQMgIABEDAwKAOeGHnXYgyAeSZG3rXYwABHaAAEDICAgUEVMC9kAW"
    "b5Z7NsYIAjNIABDZhjNGDW8ZkNDHCEBpAVAXOMBsw5PrOBAY7QALImYI7RgBnHZzYwkItHaLYwkP3blw0M5OIGZgsD2b99P3YDEzGQvfFyhAZy9QjNFgay"
    "e/t+4g1MxED2xcsRGsj1IzRbGMjO7fupNzARA9kTb5+O0EQMZEe8fX4OTMTAwMfb54ABZIc+B8wWBgZ2+/Z7AxMxMHDxSpJjAW4N1Wa4OwBvl5+dbTcIIN"
    "4BCJiIAe8bsbP9BgLE68FzYJ4XA94vNdvUGw4M9nhd38BsYxCuu+xc+wcBgyVeTzcw2xiEmyMBEzIINwcCJmYQbY4ETMwg2hwJmJhBtDkSMFGDWP+3vwMC"
    "DXoAzJwKfAAAAABJRU5ErkJggg=="
)
...
def _build_branded_workbook(req: ExportExcelRequest, exported_by: str):
    ...
    # แถว 1-2: โลโก้ Bata จริง (PNG มุมมน) แทนกล่องสีเหลี่ยมคมแบบเดิม — Excel วาดมุมมนบน cell
    # fill ไม่ได้เลย ทำให้ดูเป็น placeholder มากกว่าโลโก้จริง ตอนนี้ embed รูปจริงแทน
    ws.row_dimensions[1].height = 22
    ws.row_dimensions[2].height = 22
    try:
        logo_stream = io.BytesIO(base64.b64decode(BATA_LOGO_PNG_B64))
        logo_img = XLImage(logo_stream)
        logo_img.width = 44
        logo_img.height = 44
        ws.add_image(logo_img, "A1")
    except Exception:
        pass  # ถ้า embed รูปพลาดด้วยเหตุผลใดก็ตาม ปล่อยผ่าน ไม่ทำให้ export ทั้งไฟล์ล้ม
